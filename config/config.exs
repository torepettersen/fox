...
config :fox, FoxWeb.Endpoint,
  url: [host: "localhost"],
  render_errors: [view: FoxWeb.ErrorView, accepts: ~w(html json), layout: false],
...
config :fox, Fox.Mailer, adapter: Swoosh.Adapters.Local

# Swoosh API client is needed for adapters other than SMTP.
config :swoosh, :api_client, false

# Nordigen
config :fox, nordigen_base_url: "https://ob.nordigen.com/api/v2"
