defmodule Fox.UsersTest do
  use Fox.DataCase

  alias Fox.Users

  alias Fox.Users.{User, UserToken}
  ...
  describe "register_user/1" do
    ...
    test "registers users with a hashed password" do
      %{email: email} = params = params_for(:user, password: valid_user_password())
      {:ok, user} = Users.register_user(params)
  ...
  describe "change_user_registration/2" do
    ...
    test "allows fields to be set" do
      ...
      %{email: email} = params = params_for(:user, password: password)

      changeset = Users.change_user_registration(%User{}, params)
  ...
  describe "apply_user_email/3" do
    ...
    test "validates current password", %{user: user} do
      {:error, changeset} = Users.apply_user_email(user, "invalid", params_for(:user))
