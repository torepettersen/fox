defmodule Fox.Mocks do
  ...
  def mock(%Conn{} = conn, :list_institutions, _attrs) do
    json(conn, [
      %{
        id: "DNB_DNBANOKK",
        name: "DNB",
  ...
  def mock(%Conn{params: params} = conn, :create_requisition, attrs) do
    ...
    case params do
      %{"redirect" => redirect, "institution_id" => ^institution_id} ->
        json(conn, %{
          id: "7993ca30-8dd3-46cb-809f-eb7e7918e939",
  ...
  def mock(%Bypass{} = bypass, function, attrs) do
    Bypass.expect(bypass, fn conn ->
      mock(conn, function, attrs)
    end)
  end
